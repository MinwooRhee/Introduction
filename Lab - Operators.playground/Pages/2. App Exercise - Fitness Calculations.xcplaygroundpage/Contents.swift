...
let heartRate2D : Double = 61
let heartRate3D : Double = 63
let addHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addHRD/3
print(averageHRD)
print("they are different because integer division drops the decimals below 1")
